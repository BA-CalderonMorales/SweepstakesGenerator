...
def display_contestant_info(contestant):
    ...
    email = contestant.contestant_email
    registration = contestant.registration_id
...
def display_sweepstakes_info(sweepstakes):
    ...
    the_sweepstakes_name = sweepstakes.name
    print("\n\tHere are the sweepstakes details\n")
    print(f"\t{the_sweepstakes_name}")
    print(f"\t{display_contestant_info(sweepstakes.contestants['one'])}\n"
          f"\t{display_contestant_info(sweepstakes.contestants['two'])}\n"
          f"\t{display_contestant_info(sweepstakes.contestants['three'])}\n"
          f"\t{display_contestant_info(sweepstakes.contestants['four'])}\n")
